...
public class WordGame : MonoBehaviour
{
    ...
    public GameObject PrefabLatter;
    public Rect wordArea = new Rect(-24, 19, 48, 28);
    public float letterSize = 1.5f;
    public bool showAllWyrds = true;
    public float bigLetterSize = 4f;
    public Color bigColorDim = new Color(0.8f, 0.8f, 0.8f);
    public Color bigColorSelected = new Color(1f, 0.8f, 0.7f);
    public Vector3 bigLetterCentr = new Vector3(0, -16, 0);
    public Color[] wyrdPalettte;
    ...
    public IEnumerator FindSubWordsCoroutine(WordLevel level)
    {
        ...
        level.subWords.Sort();
        level.subWords = SortWordsByLenght(level.subWords).ToList();
        SubWordsSearchComplete();
    }
    public static IEnumerable<string> SortWordsByLenght(IEnumerable<string> ws)
    {
    ...
    void Layout()
    {
        ...
        for(int i = 0; i<currLevel.subWords.Count; i++)
        {
            ...
            {
                c = word[j];
                go = Instantiate<GameObject>(PrefabLatter);
            ...
            wyrd.color = wyrdPalettte[word.Length - WordList.WORD_LENGHT_MIN];
            wyrds.Add(wyrd);
    ...
    public void CheckWord()
    {
        ...
        if(foundTestWord)
        {
            ...
            {
                ndx = numContained-i-1; // mozhet ne - a *
                HighlighWyrd(containedWords[ndx]);
                ScoreManager.SCORE(wyrds[containedWords[ndx]], i+2);
            }
        }
        ClearBigLettersActive();
    }
    void HighlighWyrd(int ndx)
    {
